   ...
   <div class="max-w-md mx-auto p-6">
        ...
        <form class="space-y-4">
          ...
          <div>
            ...
            <input type="text" id="songtitle" name="songtitle" class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-blue-200" placeholder="z.b London Calling" required>
          </div>
          <div>
